...
export class AppointmentsController {
  ...
  @Post()
  create(@Req() req: any, @Body() dto: CreateAppointmentDto) { return this.service.create(req.tenantId, dto); }

  @Patch(':id')
  update(@Req() req: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateAppointmentDto) { return this.service.update(req.tenantId, id, dto); }
