...
export class CeapController {
  ...
  @Get('summary')
  getSummary(@Req() req: any) { return this.service.getSummary(req.tenantId); }

  @Get('monthly-chart')
  getMonthlyChart(@Req() req: any) { return this.service.getMonthlyChart(req.tenantId); }

  @Get('totals-by-category')
  getTotalsByCategory(@Req() req: any) { return this.service.getTotalsByCategory(req.tenantId); }

  @Get(':id')
  findOne(@Req() req: any, @Param('id', ParseUUIDPipe) id: string) { return this.service.findOne(req.tenantId, id); }

  @Post()
  create(@Req() req: any, @Body() dto: CreateCeapDto) { return this.service.create(req.tenantId, dto); }

  @Patch(':id')
  update(@Req() req: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateCeapDto) { return this.service.update(req.tenantId, id, dto); }
