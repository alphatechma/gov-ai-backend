...
export class VisitsController {
  ...
  @Post()
  create(@Req() req: any, @Body() dto: CreateVisitDto) { return this.service.create(req.tenantId, dto); }

  @Patch(':id')
  update(@Req() req: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateVisitDto) { return this.service.update(req.tenantId, id, dto); }
