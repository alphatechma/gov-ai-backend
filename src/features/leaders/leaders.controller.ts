...
export class LeadersController {
  ...
  @Post()
  create(@Req() req: any, @Body() dto: CreateLeaderDto) { return this.service.create(req.tenantId, dto); }

  @Patch(':id')
  update(@Req() req: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateLeaderDto) { return this.service.update(req.tenantId, id, dto); }
