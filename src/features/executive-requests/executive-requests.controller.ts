...
export class ExecutiveRequestsController {
  ...
  @Post()
  create(@Req() req: any, @Body() dto: CreateExecutiveRequestDto) { return this.service.create(req.tenantId, dto); }

  @Patch(':id')
  update(@Req() req: any, @Param('id', ParseUUIDPipe) id: string, @Body() dto: UpdateExecutiveRequestDto) { return this.service.update(req.tenantId, id, dto); }
